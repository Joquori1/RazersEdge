...
const chartIt = document.getElementById("chart-forbes");
...
frm.addEventListener("submit", (e) => {
	...
	document.getElementById("canvas-forbes").style.display="none";
...
// * * * start 01 FORBES state management * * *
document.getElementById("home-button-f1").addEventListener("click", manageStateF);
document.getElementById("home-button-f2").addEventListener("click", manageStateF);
document.getElementById("project-button-f1").addEventListener("click", manageStateF);
document.getElementById("team-button-f1").addEventListener("click", manageStateF);

function manageStateF() {     
    document.getElementById("myChart").style.display="none";
    document.getElementById("canvas-forbes").style.display="block";
}